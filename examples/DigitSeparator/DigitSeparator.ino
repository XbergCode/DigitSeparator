...
void setup() {
  ...
  // Unsigned Value
  // digitSeparateU - Min: 1 And Max: 18446744073709551615
  Serial.println(F("digitSeparateU Explain."));                  // Serial Print
  Serial.print(F("Unsigned Min Value     : "));                  // Serial Print
  Serial.println(digitSeparateU(1U, '.'));                       // Value, Thousand Separator
  ...
  double Double_Value = 1234567.123456;                          // Double Value
